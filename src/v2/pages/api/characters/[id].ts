...
import { validateBody, validateQuery, updateCharacterSchema } from '../../../../lib/validation';
import { characters, characterAppearances, characterGroups, pseuds, works } from '../../../../lib/schema/index';
...
export const GET: APIRoute = async ({ request, locals, params }) => {
  ...
  // Fetch character with pseud name and group name
  ...
  // Fetch appearances for this character
...
export const PUT: APIRoute = async ({ request, locals, params }) => {
  ...
  // Verify ownership — character's pseud must belong to this user
  ...
  // Handle groupId: allow setting to null (clearing the group)
  ...
  // Fetch updated character with names
...
export const DELETE: APIRoute = async ({ request, locals, params }) => {
  ...
  // Delete appearances first, then character (cascade should handle it, but be explicit)
